...
import 'create_accaunt2_model.dart';
export 'create_accaunt2_model.dart';

class CreateAccaunt2Widget extends StatefulWidget {
  const CreateAccaunt2Widget({super.key});

  static String routeName = 'CreateAccaunt2';
  static String routePath = '/createAccaunt2';

  @override
  State<CreateAccaunt2Widget> createState() => _CreateAccaunt2WidgetState();
}

class _CreateAccaunt2WidgetState extends State<CreateAccaunt2Widget> {
  late CreateAccaunt2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateAccaunt2Model());
