...
GoRouter createRouter(AppStateNotifier appStateNotifier, [Widget? entryPage]) =>
    GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: CreateAccaunt2Widget.routeName,
          path: CreateAccaunt2Widget.routePath,
          builder: (context, params) => CreateAccaunt2Widget(),
        ),
        FFRoute(
          name: CreateAccaunt2CopyWidget.routeName,
          path: CreateAccaunt2CopyWidget.routePath,
          builder: (context, params) => CreateAccaunt2CopyWidget(),
        )
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/splash-screen_(1).png',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
